...
class PipePair:
    def __init__(self, x, gap, window_height, gamewidget):
        ...
        bottom_height = random.uniform(window_height * 0.12, window_height - gap - window_height * 0.18) + variance
        bottom_height = max(window_height * 0.10, min(window_height - gap - window_height * 0.10, bottom_height))

        self.bottom_pipe = Pipe(x, 0, bottom_height, is_top=False, gamewidget=gamewidget)
...
class GameWidget(Widget):
    ...
    def draw_menu_background(self):
        ...
        with self.canvas.before:
            ...
            Rectangle(pos=(0, 0), size=(self.width, self.height * 0.07))  # responsive ground
    ...
    def update_layout(self, *args):
        ...
        self.score_display_label.font_size = min(self.height * 0.032, self.width * 0.048)
        self.high_score_display_label.font_size = min(self.height * 0.032, self.width * 0.048)
